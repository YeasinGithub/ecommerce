  ...
  <div class="sl-pagebody">
      <div class="card pd-20 pd-sm-40">
        ...
        <form action="{{ route('update-brand') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <input type="hidden" name="old_image" value="{{ $edits->brand_image }}">
      ...
      <div class="row row-sm">
              <div class="col-md-4">
                  <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="brand_name_en" value="{{ $edits->brand_name_en }}" placeholder="Enter brand_name_en">
                      @error('brand_name_en')
              ...
              <div class="col-md-4">
                  <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="brand_name_bn" value="{{ $edits->brand_name_bn }}" placeholder="Enter brand_name_bn">
                      @error('brand_name_bn')
                      <span class="text-danger">{{ $message }}</span>
                    @enderror
                    </div>
