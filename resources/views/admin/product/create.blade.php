            ...
            <div class="row row-sm">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea name="short_descp_en" id="summernote">{{ old('short_descp_en') }}</textarea>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea name="short_descp_bn" id="summernote2">{{ old('short_descp_bn') }}</textarea>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea name="long_descp_en" id="summernote3">{{ old('long_descp_en') }}</textarea>
                        @error('long_descp_en')
                        <span class="text-danger">{{ $message }}</span>
                      @enderror
                      </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea name="long_descp_bn" id="summernote4">{{ old('long_descp_bn') }}</textarea>
                        @error('long_descp_bn')
                        <span class="text-danger">{{ $message }}</span>
                      @enderror
                      </div>
