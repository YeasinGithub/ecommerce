          ...
          <div class="side-menu animate-dropdown outer-bottom-xs">
            ...
            <nav class="yamm megamenu-horizontal" role="navigation">
              ...
              <li class="yamm-content">
                ...
                <a href="#">
                  <img alt="" src="{{asset('fontend')}}/assets/images/banners/banner-side.png" /></a>
                </div>
                </li><!-- /.yamm-content -->
...
<!-- ============================================== SPECIAL OFFER : END ============================================== -->
			<!-- ============================================== PRODUCT TAGS ============================================== -->
@include('fontend.inc.product_tags')
<!-- ============================================== PRODUCT TAGS : END ============================================== -->
			<!-- ============================================== SPECIAL DEALS ============================================== -->
<div class="sidebar-widget outer-bottom-small wow fadeInUp">
                  ...
                  <div class="action">
                    <ul class="list-unstyled">
                      <li class="add-cart-button btn-group">
                        ...
                        <button class="btn btn-primary cart-btn" type="button">@if (session()->get('language') == 'bangla')
    ...
    <div class="tab-pane" id="category{{$category->id}}">
      ...
      <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
        ...
        @forelse($catwiseProduct as $product)
          ...
          @empty
          <h5 class="text-danger">@if(session()->get('language')== 'bangla') দুঃখিত কোনো পণ্য পাওয়া যায়নি
          @else No Product Found @endif</h5>
      @endforelse
