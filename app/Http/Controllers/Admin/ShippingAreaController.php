...
class ShippingAreaController extends Controller
{
   //create division
    ...
    public function districtCreate(){
        ...
        return view('admin.shipDistrict.create',compact('districts','divisions'));
    }
    ...
    public function districtEdit($district_id){
        ...
        return view('admin.shipDistrict.edit',compact('divisions','district'));
    }
    ...
    public function stateCreate(){
        ...
        $divisions = ShipDivision::orderBy('division_name','ASC')->get();
        return view('admin.shipState.create',compact('states','divisions'));
    }
    ...
    public function stateEdit($state_id){
        ...
        return view('admin.shipState.edit',compact('divisions','state'));
    }
